# 🌾 Kisan-Seva (Indian Agriculture RAG)

> Weather and soil analytics RAG system. Sends daily farming recommendations to Telegram channels.
...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/kisan-seva-rag/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-kisan-seva-rag.git
cd tp-kisan-seva-rag
```
...
```bash
kubectl port-forward deployment/tp-kisan-seva-rag 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── kisan_seva.py     # Main configuration file
```
...
---
*Generated by [Kisan-Seva (Indian Agriculture RAG) Studio](https://pradeeptalari14.github.io/portfolio/tools/kisan-seva-rag/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
