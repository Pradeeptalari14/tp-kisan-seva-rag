...
Thank you for your interest in improving the **Kisan-Seva (Indian Agriculture RAG)** studio resources! 🎉
...
# 2. Clone your fork
git clone https://github.com/YOUR_USERNAME/tp-kisan-seva-rag.git
...
Generated configurations come from the **[Kisan-Seva (Indian Agriculture RAG) Studio](https://pradeeptalari14.github.io/portfolio/tools/kisan-seva-rag/)**.
