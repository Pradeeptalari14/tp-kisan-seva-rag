# 🔧 Troubleshooting Guide — Kisan-Seva (Indian Agriculture RAG)
...
2. **Check official documentation:**
   - [GitHub Issues for this repo](https://github.com/Pradeeptalari14/tp-kisan-seva-rag/issues)
   - [Studio FAQ](https://pradeeptalari14.github.io/portfolio/tools/kisan-seva-rag/)
